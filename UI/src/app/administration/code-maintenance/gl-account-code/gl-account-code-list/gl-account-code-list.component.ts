...
@Component({
  selector: 'ccs-gl-account-code-list',
  templateUrl: './gl-account-code-list.component.html',
  styleUrls: ['./gl-account-code-list.component.scss']
})
export class GlAccountCodeListComponent extends BaseFormComponent {
    ...
    constructor(private service: BaseApiService<GlAccountCodeModel>, titleBarService: TitleBarService, router: Router, route: ActivatedRoute, private ns: NotificationsService, private storage: SessionService) {
